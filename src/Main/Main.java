...
public class Main {
    public static void main(String[]args){
        Player player1=new HumanPlayer("Mohamad", Color.R,new Position(0,false),new Position(50,false));
        Player player2=new HumanPlayer("Ali", Color.B,new Position(15,false),new Position(50,false));
