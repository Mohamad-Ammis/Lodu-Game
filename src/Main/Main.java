...
public class Main {
    public static void main(String[]args){
        Player player1=new HumanPlayer("Mohamad", Color.RED,new Position(0,false),new Position(51,false));
        Player player2=new HumanPlayer("Ali", Color.BLUE,new Position(15,false),new Position(11,false));
...
//            System.out.println(piece.getPosition().getIndex()+ " " +piece.getOwner().color.name());
//        game.getBoard().movePiece(piece,6);
